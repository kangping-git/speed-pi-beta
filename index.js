...
var count_10 = firebase.database().ref().child('ddcong/count/10')
var count_100 = firebase.database().ref().child('ddcong/count/100')
var count_1000 = firebase.database().ref().child('ddcong/count/1000')
var count_10000 = firebase.database().ref().child('ddcong/count/10000')
var endress = firebase.database().ref().child('ddcong/endress')
var on_up = false
...
function timer(){
    ...
    if (load == true){
        ...
        if (start == true){
            ...
            document.getElementById("timer").style.visibility = ""
            document.getElementById("setting_button").style.display = start == "nulla" ? "none" : ""
        }
    }
}
